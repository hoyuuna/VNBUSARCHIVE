...
> [!WARNING]
> LƯU Ý: Sau ngày 15/3/2026, một số tiêu chuẩn hình ảnh đã được cập nhật khắt khe hơn.
>

Hệ thống áp dụng bộ tiêu chuẩn duyệt ảnh nghiêm ngặt. Ảnh tải lên bắt buộc phải đáp ứng các tiêu chí sau:

### 0. Đúng chủ đề
* Website chỉ chấp nhận ảnh xe buýt hoạt động tại **Việt Nam**, xe buýt nước ngoài không được chấp nhận.
* Không chấp nhận ảnh **xe khách** *(từ 15/3/2026)*.
...
⚠️ **Lưu ý: Nếu cùng 1 dòng xe chỉ khác tuyến/DVVH thì có khả năng cao là cùng 1 xe**
...
* **Xe khách:** *Dừng hỗ trợ kể từ 15/2/2026*.
