...
## No More Supabase
- The project no longer uses Supabase. It uses a custom middleware in /temp/api-middleware which proxies to a self-hosted PostgREST and Postgres database.
- DO NOT ask the user to open the Supabase Dashboard.
