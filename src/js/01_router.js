            ...
            if (oauthError) {
                setTimeout(() => {
                    if (oauthError === 'not_registered') {
                        app.ui.showAlert("T�i kho?n chua du?c dang k�. Vui l�ng t?o t�i kho?n m?i.", () => app.auth.check('register'));
                    } else if (oauthError === 'no_email_provided') {
                        app.ui.showAlert("Kh�ng l?y du?c email t? nh� cung c?p. Vui l�ng th? l?i.");
                    } else {
                        app.ui.showAlert("�ang nh?p th?t b?i. Vui l�ng th? l?i.");
                    }
                    window.history.replaceState(null, null, window.location.pathname);
                }, 500);
            }
