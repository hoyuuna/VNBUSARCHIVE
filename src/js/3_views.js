...
Object.assign(window.app, {
  search: {
                ...
                initExactRouteMenu: () => {
                    const renderHtml = `<div class="px-3 py-2 text-[10px] font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100 mb-1 bg-gray-50 text-center">Tìm theo tỉnh</div>`
