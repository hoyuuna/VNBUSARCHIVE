  ...
  vehicle: {
                ...
                renderEditList: (prefix = app.vehicle.currentHistoryPrefix) => {
                    ...
                    app.vehicle.tempHistory.forEach((h, index) => {
                        ...
                        div.className = "flex flex-col sm:flex-row gap-2 items-stretch sm:items-center bg-white p-3 border border-gray-200 rounded-md text-xs hover:border-gray-400 transition mb-2";
                        div.innerHTML = `
